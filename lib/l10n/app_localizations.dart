...
abstract class AppLocalizations {
  ...
  /// Texto de ayuda para el campo de cantidad
  ///
  /// In es, this message translates to:
  /// **'0.00'**
  String get amountHint;

  /// Etiqueta para la tasa de cambio estimada
  ///
  /// In es, this message translates to:
  /// **'Tasa estimada'**
  String get estimatedRate;

  /// Etiqueta para la cantidad que recibirá
  ///
  /// In es, this message translates to:
  /// **'Recibirás'**
  String get youWillReceive;

  /// Etiqueta para el tiempo estimado de la transacción
  ///
  /// In es, this message translates to:
  /// **'Tiempo estimado'**
  String get estimatedTime;

  /// Texto del botón para realizar el cambio
  ///
  /// In es, this message translates to:
  /// **'Cambiar'**
  String get exchangeButton;

  /// Título para seleccionar criptomoneda
  ///
  /// In es, this message translates to:
  /// **'Cripto'**
  String get selectCryptoCurrency;

  /// Título para seleccionar moneda fiat
  ///
  /// In es, this message translates to:
  /// **'FIAT'**
  ...
  ///
  /// In es, this message translates to:
  /// **'Error del servidor ({statusCode}). Por favor intenta de nuevo.'**
  ...
  /// Error cuando la cantidad no es válida
  ///
  /// In es, this message translates to:
  /// **'Por favor ingresa una cantidad válida'**
  String get invalidAmount;

  /// Error cuando no hay tasas disponibles
  ///
  /// In es, this message translates to:
